...
genes_of_interest_file <- "~/Dropbox (Compbio)/prostate_spatial/data/reference/gene_lengths.txt"
genelist_name <- "Henry et al. 2018"
...
genelist <- read.table("~/Dropbox (Compbio)/prostate_spatial/data/reference/henry-2018-prostate-genes.csv", quote="\"", comment.char="")$V1
